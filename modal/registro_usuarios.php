	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header" style="background:#0E6655; color:black ">
			...
			<h2 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Registrar Usuario</h2>
		  </div>
		  ...
		  <center>
			...
			<button type="submit" class="btn btn-primary" id="guardar_datos" style="background:#0E6655 ; color:black"><i class="fas fa-save"></i> Registrar usuario</button>
		</center>
		</div>
