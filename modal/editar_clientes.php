	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header" style="background:#0E6655; color:black ">
			...
			<h2 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Actualizar Cliente</h2>
		  </div>
		  ...
		  <div class="modal-footer">
			  <center>
			<button type="button" class="btn btn-default" data-dismiss="modal"style="background:#0E6655; color:black ; font-size:14px">Cerrar</button>
			<button type="submit" class="btn btn-primary" id="actualizar_datos" style="background:#0E6655; color:black ; font-size:14px">Actualizar cliente</button>
		</center>
		</div>
		  </form>
		</div>
